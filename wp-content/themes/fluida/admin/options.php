...
'block-icons' => array(
	'no-icon',
	'users2', 'user', 'trophy', 'speedometer', 'screen-tablet', 'screen-smartphone', 'screen-desktop', 'plane', 'notebook', 'magic-wand', 'hourglass2', 'graduation', 'fire',
	'eyeglass', 'energy', 'chemistry', 'bell', 'badge', 'speech', 'puzzle', 'printer', 'present', 'pin', 'picture2', 'map', 'layers', 'globe', 'globe2', 'folder', 'feed',
	'drop', 'drawar', 'docs', 'directions', 'direction', 'cup2', 'compass', 'calculator', 'bubbles', 'briefcase', 'book-open', 'basket', 'bag', 'wrench', 'umbrella', 'tag',
	'support', 'share', 'share2', 'rocket', 'question', 'pie-chart2', 'pencil2', 'note', 'music-tone-alt', 'list2', 'like', 'home2', 'grid', 'graph', 'equalizer', 'dislike',
	'calender', 'bulb', 'chart', 'clock', 'envolope', 'flag', 'folder2', 'heart2', 'info', 'link', 'refresh', 'reload', 'settings', 'arrow-down', 'arrow-left', 'arrow-right',
	'arrow-up', 'paypal', 'home', 'apartment', 'data', 'cog', 'star', 'star-half', 'star-empty', 'paperclip', 'eye2', 'license', 'picture', 'book', 'bookmark', 'users', 'store',
	'calendar', 'keyboard', 'spell-check', 'screen', 'smartphone', 'tablet', 'laptop', 'laptop-phone', 'construction', 'pie-chart', 'gift', 'diamond', 'cup3', 'leaf', 'earth',
	'bullhorn', 'hourglass', 'undo', 'redo', 'sync', 'history', 'download', 'upload', 'bug', 'code', 'link2', 'unlink', 'thumbs-up', 'thumbs-down', 'magnifier', 'cross3', 'menu',
	'list', 'warning', 'question-circle', 'check', 'cross', 'plus', 'minus', 'layers2', 'text-format', 'text-size', 'hand', 'pointer-up', 'pointer-right', 'pointer-down',
	'pointer-left', 'heart', 'cloud', 'trash', 'user2', 'key', 'search', 'settings2', 'camera', 'tag2', 'bulb2', 'pencil', 'diamond2', 'location', 'eye', 'bubble', 'stack', 'cup',
	'phone', 'news', 'mail', 'news2', 'paperplane', 'params2', 'data2', 'megaphone', 'study', 'chemistry2', 'fire2', 'paperclip2', 'calendar2', 'wallet', 'toggle', 'layout', 'lock',
	'unlock', 'target', 'disc', 'microphone', 'play', 'cloud2', 'cloud-upload', 'cloud-download', 'plus2', 'minus2', 'check2', 'cross2'
	),
